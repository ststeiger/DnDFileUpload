...
<body>
    ...
    <iframe name="ifoo" style="width: 100%; height: 1cm;"></iframe>

    <form id="form1" runat="server" enctype="multipart/form-data" method="POST" action="FileUpload.ashx" target="ifoo">
        <input type="file" name="files[]" id="file" onchange="document.getElementById('form1').submit();" style="display: block; opacity: 0;" class="box__file" data-multiple-caption="{count} files selected" multiple="multiple">
